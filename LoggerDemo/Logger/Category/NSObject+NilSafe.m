...
//手机系统版本号
#define IOS_SYSTER_VERSION                [[[UIDevice currentDevice] systemVersion] floatValue]
...
#define IS_IOS_11_OR_LATER     @available(iOS 11.0, *)
#else
...
+ (NSString*) hookStringWithUTF8String:(const char *)nullTerminatedCString
{
    ...
    NSAssert(NO, @"NSString invalid args hookStringWithUTF8String nil cstring");
    return nil;
}
+ (nullable instancetype) hookStringWithCString:(const char *)cString encoding:(NSStringEncoding)enc
{
    ...
    NSAssert(NO, @"NSString invalid args hookStringWithCString nil cstring");
    return nil;
}
- (nullable instancetype) hookInitWithCString:(const char *)nullTerminatedCString encoding:(NSStringEncoding)encoding
{
    ...
    NSAssert(NO, @"NSString invalid args hookInitWithCString nil cstring");
    return nil;
}
...
- (nullable instancetype) hookInitWithCString:(const char *)nullTerminatedCString encoding:(NSStringEncoding)encoding
{
    ...
    NSAssert(NO, @"NSMutableString invalid args hookInitWithCString nil cstring");
    return nil;
}
- (void) hookAppendString:(NSString *)aString
{
    if (aString){
        ...
        NSAssert(NO, @"NSMutableString invalid args hookAppendString:[%@]", aString);
    }
}
- (void) hookInsertString:(NSString *)aString atIndex:(NSUInteger)loc
{
    if (aString && loc <= self.length) {
        ...
        NSAssert(NO, @"NSMutableString invalid args hookInsertString:[%@] atIndex:[%@]", aString, @(loc));
    }
}
- (void) hookDeleteCharactersInRange:(NSRange)range
{
    if (range.location + range.length <= self.length){
        ...
        NSAssert(NO, @"NSMutableString invalid args hookDeleteCharactersInRange:[%@]", NSStringFromRange(range));
    }
}
- (NSString *)hookStringByAppendingString:(NSString *)aString
{
...
+ (instancetype) hookArrayWithObject:(id)anObject
{
    ...
    NSAssert(NO, @"NSArray invalid args hookArrayWithObject:[%@]", anObject);
    return nil;
}
...
- (void) hookAddObject:(id)anObject {
    if (anObject) {
        ...
        NSAssert(NO, @"NSMutableArray invalid args hookAddObject:[%@]", anObject);
    }
}
- (id) hookObjectAtIndex:(NSUInteger)index {
    if (index < self.count) {
...
- (void) hookInsertObject:(id)anObject atIndex:(NSUInteger)index {
    if (anObject && index <= self.count) {
        ...
        if (!anObject) {
            NSAssert(NO, @"NSMutableArray invalid args hookInsertObject:[%@] atIndex:[%@]", anObject, @(index));
        }
        if (index > self.count) {
            NSAssert(NO, @"NSMutableArray hookInsertObject[%@] atIndex:[%@] out of bound:[%@]", anObject, @(index), @(self.count));
        }
    }
}
...
- (void) hookRemoveObjectAtIndex:(NSUInteger)index {
    if (index < self.count) {
        ...
        NSAssert(NO, @"NSMutableArray hookRemoveObjectAtIndex:[%@] out of bound:[%@]", @(index), @(self.count));
    }
}
...
- (void) hookReplaceObjectAtIndex:(NSUInteger)index withObject:(id)anObject {
    if (index < self.count && anObject) {
        ...
        if (!anObject) {
            NSAssert(NO, @"NSMutableArray invalid args hookReplaceObjectAtIndex:[%@] withObject:[%@]", @(index), anObject);
        }
        if (index >= self.count) {
            NSAssert(NO, @"NSMutableArray hookReplaceObjectAtIndex:[%@] withObject:[%@] out of bound:[%@]", @(index), anObject, @(self.count));
        }
    }
}
...
- (void) hookRemoveObjectsInRange:(NSRange)range {
    if (range.location + range.length <= self.count) {
        ...
        NSAssert(NO, @"NSMutableArray invalid args hookRemoveObjectsInRange:[%@]", NSStringFromRange(range));
    }
}
...
+ (instancetype) hookDictionaryWithObject:(id)object forKey:(id)key
{
    ...
    NSAssert(NO, @"NSDictionary invalid args hookDictionaryWithObject:[%@] forKey:[%@]", object, key);
    return nil;
}
+ (instancetype) hookDictionaryWithObjects:(const id [])objects forKeys:(const id [])keys count:(NSUInteger)cnt
{
    ...
    for (NSInteger i = 0; i < cnt ; ++i) {
        if (keys[i] && objects[i]) {
            ...
            NSAssert(NO, @"NSDictionary invalid args hookDictionaryWithObject:[%@] forKey:[%@]", objects[i], keys[i]);
        }
    }
...
- (void) hookSetObject:(id)anObject forKey:(id)aKey {
    if (anObject && aKey) {
        ...
        NSAssert(NO, @"NSMutableDictionary invalid args hookSetObject:[%@] forKey:[%@]", anObject, aKey);
    }
}
...
- (void) hookRemoveObjectForKey:(id)aKey {
    if (aKey) {
        ...
        NSAssert(NO, @"NSMutableDictionary invalid args hookRemoveObjectForKey:[%@]", aKey);
    }
}
...
+ (instancetype)hookSetWithObject:(id)object
{
    ...
    NSAssert(NO, @"NSSet invalid args hookSetWithObject:[%@]", object);
    return nil;
}
@end
...
- (void) hookAddObject:(id)object {
    if (object) {
        ...
        NSAssert(NO, @"NSMutableSet invalid args hookAddObject[%@]", object);
    }
}
...
- (void) hookRemoveObject:(id)object {
    if (object) {
        ...
        NSAssert(NO, @"NSMutableSet invalid args hookRemoveObject[%@]", object);
    }
}
@end
...
+ (instancetype)hookOrderedSetWithObject:(id)object
{
    ...
    NSAssert(NO, @"NSOrderedSet invalid args hookOrderedSetWithObject:[%@]", object);
    return nil;
}
- (instancetype)hookInitWithObject:(id)object
{
    ...
    NSAssert(NO, @"NSOrderedSet invalid args hookInitWithObject:[%@]", object);
    return nil;
}
...
- (void)hookAddObject:(id)object {
    if (object) {
        ...
        NSAssert(NO, @"NSMutableOrderedSet invalid args hookAddObject:[%@]", object);
    }
}
- (void)hookInsertObject:(id)object atIndex:(NSUInteger)idx
{
    if (object && idx <= self.count) {
        ...
        NSAssert(NO, @"NSMutableOrderedSet invalid args hookInsertObject:[%@] atIndex:[%@]", object, @(idx));
    }
}
- (void)hookRemoveObjectAtIndex:(NSUInteger)idx
{
    if (idx < self.count){
        ...
        NSAssert(NO, @"NSMutableOrderedSet invalid args hookRemoveObjectAtIndex:[%@]", @(idx));
    }
}
- (void)hookReplaceObjectAtIndex:(NSUInteger)idx withObject:(id)object
{
    if (object && idx < self.count) {
        ...
        NSAssert(NO, @"NSMutableOrderedSet invalid args hookReplaceObjectAtIndex:[%@] withObject:[%@]", @(idx), object);
    }
}
@end
...
- (void)hookSetObject:(id)obj forKey:(id)key // 0 cost
{
    if (obj && key) {
        ...
        NSAssert(NO, @"NSCache invalid args hookSetObject:[%@] forKey:[%@]", obj, key);
    }
}
- (void)hookSetObject:(id)obj forKey:(id)key cost:(NSUInteger)g
{
    if (obj && key) {
        ...
        NSAssert(NO, @"NSCache invalid args hookSetObject:[%@] forKey:[%@] cost:[%@]", obj, key, @(g));
    }
}
@end
